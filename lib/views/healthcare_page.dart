...
class HealthCarePage extends ConsumerWidget {
  const HealthCarePage({super.key});

  @override
  Widget build(BuildContext context, ref) {
    final healthcareNewsData = ref.watch(healthcareArticleProvider);
    ...
    return Scaffold(
      ...
      body: healthcareNewsData.when(
        data: (healthcareNewsData) {
          List<Article> newsList = healthcareNewsData.map((e) => e).toList();
